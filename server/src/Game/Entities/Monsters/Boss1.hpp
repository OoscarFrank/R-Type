#ifndef BOSS1MONSTER_HPP
#define BOSS1MONSTER_HPP
...
class Boss1Monster: public Monster {
    public:
         ...
         */
        Boss1Monster(Room &room, u_int id, short x, short y);
        /**
         * @brief Construct a new Little Monster object
         *
         * @param room The room where the entity is
         ...
         */
        Boss1Monster(Room &room, u_int id, const std::pair<short, short> &pos);
        virtual ~Boss1Monster() = default;
