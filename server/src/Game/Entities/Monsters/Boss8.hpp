#ifndef BOSS8MONSTER_HPP
#define BOSS8MONSTER_HPP
...
class Boss8Monster: public Monster {
    public:
         ...
         */
        Boss8Monster(Room &room, u_int id, short x, short y);
        /**
         * @brief Construct a new Little Monster object
         *
         * @param room The room where the entity is
         ...
         */
        Boss8Monster(Room &room, u_int id, const std::pair<short, short> &pos);
        virtual ~Boss8Monster() = default;
        ...
        private:
            ...
            std::chrono::system_clock::time_point _lastFire3;
